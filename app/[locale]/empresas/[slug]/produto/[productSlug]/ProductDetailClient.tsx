...
export default function ProductDetailClient({
    ...
    const handleShare = (type: 'whatsapp' | 'facebook' | 'linkedin' | 'twitter' | 'copy') => {
        const text = encodeURIComponent(`Confira este produto: ${product.name} de ${company.name} no Base de Dados Agro - ${shareUrl}`);
    ...
    const handleOrder = () => {
        ...
        const message = encodeURIComponent(`Olá! Tenho interesse no produto *${product.name}* que vi no Base de Dados Agro. Poderiam dar-me mais informações?`);
                    ...
                    <div className="group bg-white rounded-[15px] border border-slate-200 shadow-md card-interactive transition-all duration-500 flex flex-col relative overflow-hidden">
                        ...
                        <div className="p-6 flex flex-col pt-4">
                            ...
                            <p className="text-sm font-bold text-slate-400 mb-6 leading-normal">
                                Disponível para encomenda direta via Base de Dados Agro em Moçambique.
                            </p>
