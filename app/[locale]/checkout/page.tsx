    ...
    return (
        <div className="flex flex-col lg:flex-row gap-[20px]">
            {/* honeypot anti-bot — invisível para humanos. Fica fora do
                <form>/<main> de propósito: lá dentro era o primeiro filho de
                um space-y-[10px] e, mesmo posicionado fora do ecrã, ainda
                conta como irmão para essa regra — empurrava 10px indevidos
                para o campo seguinte (dados da conta). Aqui fora, o
                container é gap (flex), que ignora elementos "absolute". */}
            <input
                type="text"
