...
export function AuthForm(props: AuthFormProps) {
    ...
    const handleAuth = async (e: React.FormEvent) => {
        ...
        const timeTaken = formLoadTime ? Date.now() - formLoadTime : 5000;
                ...
                <div className="bg-white rounded-[15px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.15),0_0_20px_rgba(249,115,22,0.05)] p-9 border border-slate-100 form-premium-card ring-1 ring-black/[0.05] relative overflow-hidden">
                    ...
                    {isRecoveryMode ? (
                        <form onSubmit={handleSetNewPassword} className="space-y-4">
                            <p className="text-sm text-slate-500 text-center mb-2">Defina a sua nova senha de acesso.</p>
                            <div className="relative">
                                ...
                                <div className="candy-border-wrapper rounded-agro-btn">
                                    <Input
                                        ...
                                        className="pl-11 pr-11 h-10 bg-white/95 backdrop-blur-sm focus:bg-white border-white/20 shadow-sm border-none focus-candy text-[13px] text-slate-900 placeholder:text-slate-400 rounded-agro-btn transition-all duration-300 relative z-10"
                                        value={newPassword}
                                ...
                                <button
                                    ...
                                    className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 transition-colors z-20"
                                >
